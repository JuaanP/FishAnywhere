...
public class ModConfigScreen extends Screen {
    ...
    public ModConfigScreen(Screen lastScreen, Options options) {
        super(TITLE);
    ...
    protected void addOptions() {
        OptionInstance<Boolean> scrollNewOffers = OptionInstance.createBoolean(
                Constants.MOD_ID + ".config.scrollNewOffers",
                getScrollNewOffers(),
    ...
    private void resetToDefaults() {
        ...
        this.minecraft.setScreen(new ModConfigScreen(this.lastScreen, this.options));
    }
