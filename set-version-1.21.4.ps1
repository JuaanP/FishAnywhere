# Script para cambiar la configuración del proyecto a Minecraft 1.21.4
$version = "1.21.4"
$javaVersion = "21"
...
# Fabric
fabric_version=0.93.3+1.21.4
fabric_loader_version=0.16.10

# Forge
forge_version=52.0.70
forge_loader_version_range=[4,)

# NeoForge
neoforge_version=21.4.5
neo_form_version=1.21.4-20240808.144430
